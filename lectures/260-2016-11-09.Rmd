...
- Excitatory endplate potential
    + nAChR opening allows Na+/K+ flux
    + Muscle fibers depolarize
    + Depolarization spreads along fibers like an action potential
    + Voltage-gated Ca++ channels within muscle fiber Ca++ stores open
    + Ca++ released

## How skeletal muscles contract

- Muscle fibers contain stacks of sarcomeres
...
<div class="centered">
<iframe width="560" height="315" src="https://www.youtube.com/embed/hr1M4SaF1D4" frameborder="0" allowfullscreen></iframe>
</div>

## Muscles only contract or relax

- How do we move both ways?
...
## Muscle fiber types specialize for different functions
