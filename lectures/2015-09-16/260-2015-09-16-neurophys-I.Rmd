...
- Go over [Quiz 1](https://rawgit.com/psu-psychology/psych-260/master/quiz/psych-260-quiz-1.pdf)
- Neurophysiology
...
|-----|------------------------|---------------------|--------------|
| K+  | Inside >> Outside      | - (pushes K+ in)    | Higher       |
...
|-----|------------------------|---------------------|
| K+  | Inside >> Outside      | - (pushes K+ in)    |
| Na+ | Outside >> Inside      | - (pulls Na+ in)    |
